...
with open("title.akas.tsv", "r") as f:
    ...
    for line in f:
        ...
        newVals.append(values[6])
        newVals.append(values[7])
        # Insert the values into the database
        cursor.execute("INSERT INTO \"Stats\".title_akas (titleid, ordering, title, region, language, types, attributes, isoriginaltitle) VALUES(%s, %s, %s, %s, %s, %s, %s, %s)", newVals)
